...
function getShashin() {
    ...
    if ((startDate === null || startDate === "") && (endDate === null || endDate === "")) {
        ...
        showToast("Warning", "Start date missing. Defaulting dates to empty string.", "#CC5500");
        startDate = "";
        endDate = "";
        ...
        showToast("Warning", "End date missing. Defaulting dates to empty string.", "#CC5500");
        startDate = "";
        endDate = "";
    }
    ...
    if (startDate !== "" && !isValidDate(startDate)) {
        ...
        showToast("Warning", "Start date invalid.", "#CC5500");
        startDate = "";
    }
    if (endDate !== "" && !isValidDate(endDate)) {
        console.warn("Warning: End date invalid. Must be format YYY-MM-DD.");
        showToast("Warning", "End date invalid.", "#CC5500");
        endDate = "";
    }
    if (startDate !== "" && endDate !== "") {
        ...
        if (startDateObj > endDateObj) {
            ...
            showToast("Warning", "Start date must not be greater than end date.", "#CC5500");
        }
    }
